...
const GeneratedNews = ({ news, onReset }: GeneratedNewsProps) => {  
  ...
  return (
    ...
    >
      ...
      >
        <div className="news-header-gradient text-white p-8">
          <motion.h1 
        ...
        <motion.div 
          className="bg-amber-50 border-l-4 border-amber-400 px-6 py-4"
        ...
        <motion.div 
          className="bg-gray-50 px-8 py-6 border-t border-gray-100"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      {news.font && news.font.length > 0 && (
        ...
        >
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
            ...
            <p className="text-gray-600 mt-1">Referências e materiais consultados para esta notícia</p>
          </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      {fontIsUrl(font) ? (
                        ...
                        <span className="text-gray-700 break-all">{font}</span>
                      )}
                    </div>
                  </div>
                </motion.div>
